...
# PhysHlth vs. Diabetes_012 by Sex and Income
col_labels_inc = ['Income: < $10,000', 'Income: < $15,000', 'Income: < $20,000', 'Income: < $25,000', 'Income: < $35,000', 'Income: < $50,000', 'Income: < $75,000', 'Income: > $75,000']
sns_catplot(diabetes, 'Diabetes_012', 'PhysHlth', hue='Sex', col='Income', col_wrap=4, legend_labels=legend_labels_sex,
            xticks=xticks, title='PhysHlth vs. Diabetes Status by Income and Sex', xlabel=xlabel, col_labels=col_labels_inc)

# MentHlth vs. Diabetes_012 by Sex and HighBP
col_labels_bp = ['No High Blood Pressure', 'Has High Blood Pressure']
sns_catplot(diabetes, 'Diabetes_012', 'MentHlth', hue='Sex', col='HighBP', legend_labels=legend_labels_sex,
            xticks=xticks, title='MentHlth vs. Diabetes Status by High Blood Pressure and Sex', xlabel=xlabel, col_labels=col_labels_bp)

# MentHlth vs. Diabetes_012 by Sex and Income
col_labels_inc = ['Income: < $10,000', 'Income: < $15,000', 'Income: < $20,000', 'Income: < $25,000', 'Income: < $35,000', 'Income: < $50,000', 'Income: < $75,000', 'Income: > $75,000']
sns_catplot(diabetes, 'Diabetes_012', 'MentHlth', hue='Sex', col='Income', col_wrap=4, legend_labels=legend_labels_sex,
            xticks=xticks, title='MentHlth vs. Diabetes Status by Income and Sex', xlabel=xlabel, col_labels=col_labels_inc)
